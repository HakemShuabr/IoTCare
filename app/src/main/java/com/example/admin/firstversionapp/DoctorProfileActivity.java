...
public class DoctorProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        specialization.setText(intent.getExtras().getString("specialization"));
        ...
        final DatabaseReference doctorDate = database.getReference(systemCode).child("users").child("doctors").child(this.username.getText().toString()).child("image");
        doctorDate.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()) {
                    if(!dataSnapshot.getValue().toString().equals("null")) {
                        ...
                        Toast.makeText(DoctorProfileActivity.this, "click on image space to add an image", Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == RESULT_CANCELED){}
            ...
            final DatabaseReference userData = database.getReference(systemCode).child("users").child("doctors").child(this.username.getText().toString()).child("image");
            userData.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        Toast.makeText(DoctorProfileActivity.this, "error while uploading the image!", Toast.LENGTH_LONG).show();
                    }
                }
